      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-6 text-foreground/80 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>MyAIWork aggregates third-party AI tools. We do not own or control those tools.</li>
              <li>Users are responsible for reviewing the terms and privacy of any third-party tools they use.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-primary mb-2">3. No Guarantees</h2>
            <p>We try to keep information accurate and updated, but we don’t guarantee it will always be correct or available.</p>
          </section>
